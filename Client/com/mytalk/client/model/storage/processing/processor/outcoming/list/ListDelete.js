...
* - Zucchetti SRL
*
* Processore che viene eseguito quando l'utente sceglie di cancellare una lista personalizzata
*
*/
...
MyTalk.processor.ListDelete = Ember.Object.extend(MyTalk.AbstractOutProcessorProduct,{
  ...
  */
 /**
  * Il metodo deve inviare al server un ARI avente richiesta _ListDelete_ 
  *
  * @method +sendToServer
