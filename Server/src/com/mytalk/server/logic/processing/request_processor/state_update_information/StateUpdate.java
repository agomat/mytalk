...
* stato di un utente. Essa, a differenza delle altre richieste, non viene fatta dal client ma è 
...
public class StateUpdate extends GenericRequest{
	 ...
	 * del campo richiesta del pacchetto per determinare se il nuovo stato è online(Login) od 
	 ...
	 *  cancellazione di un account, è necessario un procedimento diverso per recuperare le 
	 *  informazioni relative all'utente che ne fa richiesta, poiché i suoi dati vengono cancellati 
	 *  dal server, perciò si utilizzano i dati contenuti nella parte information del ARI che viene 
	 *  ricevuto in input
	 *  
	 *  @method +manage
