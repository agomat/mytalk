/**
* Filename: ListNotExistingListDelete.js
...
* - Zucchetti SRL
*
* Processore che viene eseguito quando il server rileva che la lista che si tenta di cancellare
* un lista non esistente. Il client
* deve ignorare questo tipo di richiesta e di conseguenza il metodo _process_ deve avere corpo vuoto
*
*/


MyTalk.processor.ListNotExistingListDelete = Ember.Object.extend(MyTalk.AbstractInProcessorProduct, {
  /**
  ...
  * @type {String}
  */
  name: 'ListNotExistingListDelete',
