...
MyTalk.WebSocketHandler = Ember.Object.extend(MyTalk.IPAddressProxy, MyTalk.RequestManager, {
  uri: 'ws://localhost:8080/MyTalk/atmosphere/chat/',
  ...
  init: function() {  // TODO PASSARE COME PARAMETRI LA CALLBACK onmessage
    ...
    this.ws.all.onmessage = function(data) {
      ...
      obj = {
        id: 0,
        list: [{ username:'user_1',online:true,nome:'Nome',cognome:'Cognome',ip:'192.168.1.1', user:0 },
               { username:'user_2',online:true,nome:'Nome',cognome:'Cognome',ip:'192.168.1.1', user:0 }]
      },
      type = MyTalk.WUser,
  ...
  send: function(data) { 
    ...
    var a = MyTalk.Authentication.find(0).getObject().username;
    var r = 'some';
    var i = data.getObject();
