...
* - Zucchetti SRL
*
* Processore che viene eseguito quando il server rileva che la lista che si vuole creare ha lo stesso
* nome di una lista già esistente. Il client
* deve ignorare questo tipo di richiesta e di conseguenza il metodo _process_ deve avere corpo vuoto
*
*/

MyTalk.processor.ListAlreadyExists = Ember.Object.extend(MyTalk.AbstractInProcessorProduct, {
  /**
