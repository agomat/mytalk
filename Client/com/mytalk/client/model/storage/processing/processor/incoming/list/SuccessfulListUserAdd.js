/**
* Filename: SuccessfulListUserAdd.js
...
* - Zucchetti SRL
*
* Processore che viene eseguito quando il server ha aggiunto correttamente un utente ad una lista. Il client
* deve ignorare questo tipo di richiesta e di conseguenza il metodo _process_ deve avere corpo vuoto
*
*/

MyTalk.processor.SuccessfulListUserAdd = Ember.Object.extend(MyTalk.AbstractInProcessorProduct, {
  /**
