/**
* Filename: ListNotExistingRenameList.js
...
* - Zucchetti SRL
*
* Processore che viene eseguito quando il server rileva che si sta tentando di rinominare una lista
* non esistente. Il client deve ignorare questo tipo di richiesta e di conseguenza il metodo _process_ deve avere corpo vuoto
*
*/

MyTalk.processor.ListNotExistingRenameList = Ember.Object.extend(MyTalk.AbstractInProcessorProduct, {
  /**
  ...
  * @type {String}
  */
  name: 'ListNotExistingRenameList',
