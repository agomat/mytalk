/**
* Filename: UserAlreadyBlacklisted.js
...
* - Zucchetti SRL
*
* Processore che viene eseguito quando il server rileva che l'utente che si vuole aggiungere alla $Blacklist$
* è già in $Blacklist$. Il client
* deve ignorare questo tipo di richiesta e di conseguenza il metodo _process_ deve avere corpo vuoto
*
*/

MyTalk.processor.UserAlreadyBlacklisted = Ember.Object.extend(MyTalk.AbstractInProcessorProduct, {
  /**
