...
* - Zucchetti SRL
*
* Processore che viene eseguito quando il server rileva che l'utente che si vuole rimuovere dalla lista, non
* è presente nella lista. Il client
* deve ignorare questo tipo di richiesta e di conseguenza il metodo _process_ deve avere corpo vuoto
*
*/
MyTalk.processor.UserNotListed = Ember.Object.extend(MyTalk.AbstractInProcessorProduct, {
  /**
