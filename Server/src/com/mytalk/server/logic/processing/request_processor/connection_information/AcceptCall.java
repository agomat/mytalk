...
public class AcceptCall extends GenericRequest{
	 ...
	 * si puo' controllare se l'indirizzo Ip e' online. Se presente, si puo' rispondere con un nuovo 
	 * pacchetto ARI, specificando che la richiesta e' andata a buon fine: "SuccessfulAcceptCall".
	 *  In tale pacchetto e' presente la stessa Information ricevuta e, riguardo l'Authentication, 
	 *  viene creato un oggetto Authentication contenente l'indirizzo ip del ricevente. 
	 *  In caso opposto, si segnalera' che la richiesta non ha avuto successo: 
	 *  "UnsuccessfulAcceptCall", anche in questo caso il campo Information rimane invariato e non 
	 *  vi e' la parte Authentication
	 *  
	 *  @method +manage
