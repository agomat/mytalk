...
public class DeleteAccount extends GenericRequest{
	 ...
	 *  alla componente CSDAT2, il metodo che si occuperà di eliminare l'utente. Tale operazione 
	 *  può avere successo, restituendo "SuccessfulDeleteAccount", o insuccesso con
