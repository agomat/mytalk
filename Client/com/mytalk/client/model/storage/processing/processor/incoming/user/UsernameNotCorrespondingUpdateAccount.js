/**
* Filename: UsernameCorrespondingExistingLogin.js
...
* - Zucchetti SRL
*
* Processore che viene eseguito quando il server rileva il campo $authentication$ di _ARI_ è di un utente diverso
* rispetto ai dati dell'utente contenuti nel campo $info$
*
*/

MyTalk.processor.UsernameNotCorrespondingUpdateAccount = Ember.Object.extend(MyTalk.AbstractInProcessorProduct, {
  /**
  ...
  * @type {String}
  */
 name: 'UsernameNotCorrespondingUpdateAccount',
 /**
