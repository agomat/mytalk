/**
* Filename: SuccessfulListUserRemove.js
...
* - Zucchetti SRL
*
* Processore che viene eseguito quando il server ha rimosso correttamente un utente da una lista. Il client
* deve ignorare questo tipo di richiesta e di conseguenza il metodo _process_ deve avere corpo vuoto
*
*/

MyTalk.processor.SuccessfulListUserRemove = Ember.Object.extend(MyTalk.AbstractInProcessorProduct, {
  /**
