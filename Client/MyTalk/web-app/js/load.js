...
// bootstrap views
head.js("js/view/ContentView.js");
head.js("js/view/IndexView.js");
head.js("js/view/ListsView.js");
head.js("js/view/LoginFormView.js");
head.js("js/view/LoginView.js");
head.js("js/view/RegisterFormView.js");
head.js("js/view/RegisterPassword.js");
head.js("js/view/IPCall.js");
head.js("js/view/ListView.js");
head.js("js/view/Login.js");
head.js("js/view/RegisterConfirmPassword.js");
head.js("js/view/Register.js");
head.js("js/view/RegisterSurname.js");
head.js("js/view/Header.js");
head.js("js/view/IPFormView.js");
head.js("js/view/LoginEmail.js");
head.js("js/view/LoginPassword.js");
head.js("js/view/RegisterEmail.js");
head.js("js/view/RegisterName.js");
head.js("js/view/RegisterUsername.js");
