...
* - Zucchetti SRL
*
* Processore che viene eseguito quando l'utente sceglie di aggiungere un utente ad una lista
*
*/
...
MyTalk.processor.ListUserAdd = Ember.Object.extend(MyTalk.AbstractOutProcessorProduct,{
  ...
  */
 /**
  * Il metodo deve inviare al server un ARI avente richiesta _ListUserAdd_ 
  *
  * @method +sendToServer
