...
* - Zucchetti SRL
*
* Processore che viene eseguito quando il server ha salvato con successo i dati dell'ultima chiamata che
* il client ha eseguito. Il client
* deve ignorare questo tipo di richiesta e di conseguenza il metodo _process_ deve avere corpo vuoto
*
*/

MyTalk.processor.SuccessfulAddCall = Ember.Object.extend(MyTalk.AbstractInProcessorProduct, {
  /**
