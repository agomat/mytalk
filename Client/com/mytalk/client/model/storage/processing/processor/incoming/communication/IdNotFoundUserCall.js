/**
* Filename: IdNotFoundUserCall.js
...
* - Zucchetti SRL
*
* Processore che viene eseguito quando il server non riesce a trovare l'id del chiamato nel proprio database. Il client
* deve ignorare questo tipo di richiesta e di conseguenza il metodo _process_ deve avere corpo vuoto
*
*/

MyTalk.processor.IdNotFoundUserCall = Ember.Object.extend(MyTalk.AbstractInProcessorProduct, {
  /**
